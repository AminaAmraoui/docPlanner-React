...
import './docbrand.css';
let svgLink = <svg xmlns="http://www.w3.org/2000/svg" width="220" height="32" viewBox="0 0 220 32">
...
//list of brand component
function DocBrands(props){
    return props.brandList.map((currentBrand, i) =>
          <DocBrand brand={currentBrand} key={i}/>
      )
    }
...
const ListBrand = (props) =>
      <ul>
      <DocBrands brandList={props.content}/>
      </ul>
